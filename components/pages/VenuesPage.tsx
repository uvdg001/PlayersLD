                    ...
                    <div key={venue.id} className="flex items-start justify-between p-3 bg-gray-100 dark:bg-gray-700 rounded-lg">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                {venue.mapLink && <a href={venue.mapLink} target="_blank" rel="noopener noreferrer" className="text-sm text-blue-500 hover:underline">Ver en mapa</a>}
                            </div>
                        </div>
                        {isAdmin && (
                            <div className="flex flex-col space-y-2">
                                ...
                                <button onClick={() => onDeleteVenue(venue.id)} className="p-2 text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300">
