            ...
            <HelpSection title="Para el Administrador">
                ...
                <Feature title="Gestión de Partidos">
                 ...
                 <Feature title="Abrir/Cerrar Calificaciones">
                    En la tarjeta del partido, encontrarás un botón para abrir las calificaciones post-partido. Mientras estén abiertas, los jugadores podrán votarse. ¡No olvides cerrarlas después de un tiempo prudencial!
                </Feature>
                <Feature title="Armar Equipos con IA">
                    Una vez que tengas suficientes jugadores confirmados, presiona el botón "Armar Equipos con IA" para que Gemini genere dos equipos balanceados automáticamente.
                </Feature>
            </HelpSection>
