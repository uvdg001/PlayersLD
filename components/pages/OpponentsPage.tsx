                    ...
                    <div key={opponent.id} className="flex items-center justify-between p-3 bg-gray-100 dark:bg-gray-700 rounded-lg">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <StarRating rating={opponent.skillLevel} />
                            </div>
                        </div>
                        {isAdmin && (
                            <div className="flex space-x-2">
                                ...
                                <button onClick={() => onDeleteOpponent(opponent.id)} className="p-2 text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300">
