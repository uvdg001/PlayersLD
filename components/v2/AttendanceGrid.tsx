        ...
        <div className="fixed inset-0 z-[110] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn" onClick={onClose}>
            <div className="bg-white dark:bg-gray-800 rounded-[2.5rem] w-full max-w-sm overflow-hidden shadow-2xl border-4 border-indigo-500" onClick={e => e.stopPropagation()}>
                <header className="p-6 text-center bg-gray-50 dark:bg-gray-900 border-b dark:border-gray-700 relative">
                    ...
                    <img src={player.photoUrl} className="w-32 h-32 rounded-full mx-auto border-4 border-white shadow-lg mb-3 object-cover" />
                    <h3 className="text-4xl font-black uppercase tracking-tighter italic text-indigo-600 leading-tight">{player.nickname}</h3>
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1">Planilla Rápida de Campo</p>
                </header>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="pt-4 border-t dark:border-gray-700 mt-2">
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                <span className="text-xs opacity-80 mb-1">Cargar Pago Justo</span>
                                <span className="text-2xl">$ {Math.round(fairShare)} ⚡</span>
                            </button>
                        </div>
                    </div>
                </div>
